...
void COptions::LoadOptions()
{
	...
	if (flag == 1)
	{
        ...
        GetPrivateProfileString("GameServer", "Address","bc.outiva.com",_gameServerAddress,255,buffer);
        ...
        this->gameServerAddress = "bc.outiva.com";
